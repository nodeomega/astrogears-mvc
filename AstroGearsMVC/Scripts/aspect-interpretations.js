...
(function (AspectInterpretations) {
    ...
    function GetAspectInterpretationListing(page, numberPerPage) {
        listing = true;
    ...
    AspectInterpretations.GetAspectInterpretationListing = GetAspectInterpretationListing;
    function OpenCreateForm() {
        $('#createAspectInterpretationModal').modal('show');
    }
    AspectInterpretations.OpenCreateForm = OpenCreateForm;
    function OpenEditForm(id) {
        $('#editAspectInterpretationModal').modal('show');
        GetEditData(id);
    }
    AspectInterpretations.OpenEditForm = OpenEditForm;
    function OpenDeleteForm(id) {
        $('#deleteAspectInterpretationModal').modal('show');
        var jqxhr = $.getJSON('/AspectInterpretations/GetAspectInterpretationForDelete', { id: id }).done(function (data) {
    ...
    AspectInterpretations.OpenDeleteForm = OpenDeleteForm;
    ...
    AspectInterpretations.SetUpAspectInterpretationDropdowns = SetUpAspectInterpretationDropdowns;
    ...
    AspectInterpretations.SetUpAspectDropdown = SetUpAspectDropdown;
    ...
    AspectInterpretations.SetUpAngleDropdown = SetUpAngleDropdown;
    ...
    AspectInterpretations.SetUpIdsForEntry = SetUpIdsForEntry;
    ...
    $('#confirmAspectInterpretationCreate').click(function () {
        ...
        var reorderedIds = SetUpIdsForEntry($('#createAspectInterpretationTypeId1').val(), $('#createCelestialObject1Id').val(), ($('input[name=createFirstAspectSelection]:checked').val()) === 'celestialObject1' ? true : false, $('#createAngle1Id').val(), ($('input[name=createFirstAspectSelection]:checked').val()) === 'angle1' ? true : false, $('#createAspectInterpretationTypeId2').val(), $('#createCelestialObject2Id').val(), ($('input[name=createSecondAspectSelection]:checked').val()) === 'celestialObject2' ? true : false, $('#createAngle2Id').val(), ($('input[name=createSecondAspectSelection]:checked').val()) === 'angle2' ? true : false);
        if (reorderedIds === null) {
            $('#status').html(errorIcon + ' An impossible error occured, but we have this message anyways.');
            return;
        }
        var aspectType1Id = reorderedIds[0], celObj1Id = reorderedIds[1], angle1Id = reorderedIds[2], aspectType2Id = reorderedIds[3], celObj2Id = reorderedIds[4], angle2Id = reorderedIds[5];
    ...
    $('#confirmAspectInterpretationEdit').click(function () {
        var sunId = 1, earthId = 5;
        var reorderedIds = SetUpIdsForEntry($('#editAspectInterpretationTypeId1').val(), $('#editCelestialObject1Id').val(), ($('input[name=editFirstAspectSelection]:checked').val()) === 'celestialObject1' ? true : false, $('#editAngle1Id').val(), ($('input[name=editFirstAspectSelection]:checked').val()) === 'angle1' ? true : false, $('#editAspectInterpretationTypeId2').val(), $('#editCelestialObject2Id').val(), ($('input[name=editSecondAspectSelection]:checked').val()) === 'celestialObject2' ? true : false, $('#editAngle2Id').val(), ($('input[name=editSecondAspectSelection]:checked').val()) === 'angle2' ? true : false);
        if (reorderedIds === null) {
    ...
    AspectInterpretations.ResetCreateForm = ResetCreateForm;
    ...
    AspectInterpretations.GetEditData = GetEditData;
...
//# sourceMappingURL=aspect-interpretations.js.map
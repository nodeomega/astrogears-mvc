...
(function (TransitDetails) {
    var listing1 = false, listing2 = false, aspects = false;
    ...
    function GetAvailableChartsForTransit(chartId) {
    ...
    TransitDetails.GetAvailableChartsForTransit = GetAvailableChartsForTransit;
    function GetSelectedTransitChartData(transitChartId) {
        if (transitChartId === '-') {
    ...
    TransitDetails.GetSelectedTransitChartData = GetSelectedTransitChartData;
    function RefreshCharts(id, transitId) {
        listing1 = true;
        listing2 = true;
    ...
    TransitDetails.RefreshCharts = RefreshCharts;
    function GetFirstChartListing(id) {
        listing1 = true;
        aspects = false;
        //$('#chartbody').empty();
        $.ajaxSetup({ cache: false });
    ...
    TransitDetails.GetFirstChartListing = GetFirstChartListing;
    function GetSecondChartListing(transitChartId) {
        if (transitChartId === '-') {
    ...
    TransitDetails.GetSecondChartListing = GetSecondChartListing;
    function GetHouseListing(chartId, chartNumber) {
        if (chartId === '-') {
            if (chartNumber === 2) {
    ...
    TransitDetails.GetHouseListing = GetHouseListing;
    ...
    function GetTransitAspects(id, chartToCompare) {
    ...
    TransitDetails.GetTransitAspects = GetTransitAspects;
    function GetInterpretation(tag, chartTypeId1, celestialObjectId1, angleId1, aspectId, chartTypeId2, celestialObjectId2, angleId2) {
        if ($(tag + ' > ul').length > 0) {
            $(tag + ' > ul').remove();
    ...
    TransitDetails.GetInterpretation = GetInterpretation;
    function GetTransitAspectsForAngleChart(angleName, angleCoordinates, chartToCompare) {
        if ($('#secondEnteredChartSelection').val() === '-') {
            return;
        }
        $('#transitAspectListModal').modal('show');
    ...
    TransitDetails.GetTransitAspectsForAngleChart = GetTransitAspectsForAngleChart;
    function GetTransitAspectsForArabicChart(arabicPartName, arabicPartCoordinates, chartToCompare) {
        if ($('#secondEnteredChartSelection').val() === '-') {
            return;
        }
        $('#transitAspectListModal').modal('show');
    ...
    TransitDetails.GetTransitAspectsForArabicChart = GetTransitAspectsForArabicChart;
    function GetTransitAspectsForDraconicChart(draconicName, draconicCoordinates, chartToCompare) {
        if ($('#secondEnteredChartSelection').val() === '-') {
            return;
        }
        $('#transitAspectListModal').modal('show');
    ...
    TransitDetails.GetTransitAspectsForDraconicChart = GetTransitAspectsForDraconicChart;
    function GetTransitAspectsForMidpointChart(midpointName, midpointCoordinates, chartToCompare) {
        if ($('#secondEnteredChartSelection').val() === '-') {
            return;
        }
        $('#transitAspectListModal').modal('show');
    ...
    TransitDetails.GetTransitAspectsForMidpointChart = GetTransitAspectsForMidpointChart;
    ...
    TransitDetails.SetUpListItemElementForAspect = SetUpListItemElementForAspect;
...
//# sourceMappingURL=transit-details.js.map
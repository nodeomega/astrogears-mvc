...
(function (SynastryDetails) {
    ...
    function GetAvailableChartsForSynastry(chartId) {
    ...
    SynastryDetails.GetAvailableChartsForSynastry = GetAvailableChartsForSynastry;
    function GetSelectedSynastryChartData(synastryChartId) {
        if (synastryChartId === '-') {
    ...
    SynastryDetails.GetSelectedSynastryChartData = GetSelectedSynastryChartData;
    function RefreshCharts(id, synastryId) {
        listing1 = true;
        listing2 = true;
    ...
    SynastryDetails.RefreshCharts = RefreshCharts;
    ...
    SynastryDetails.GetFirstChartListing = GetFirstChartListing;
    function GetSecondChartListing(synastryChartId) {
        if (synastryChartId === '-') {
    ...
    SynastryDetails.GetSecondChartListing = GetSecondChartListing;
    ...
    SynastryDetails.GetHouseListing = GetHouseListing;
    ...
    function GetSynastryAspects(id, chartToCompare) {
    ...
    SynastryDetails.GetSynastryAspects = GetSynastryAspects;
    ...
    SynastryDetails.GetInterpretation = GetInterpretation;
    function GetSynastryAspectsForAngleChart(angleName, angleCoordinates, chartToCompare) {
        if ($('#secondEnteredChartSelection').val() === '-') {
            return;
        }
        $('#synastryAspectListModal').modal('show');
    ...
    SynastryDetails.GetSynastryAspectsForAngleChart = GetSynastryAspectsForAngleChart;
    function GetSynastryAspectsForArabicChart(arabicPartName, arabicPartCoordinates, chartToCompare) {
        if ($('#secondEnteredChartSelection').val() === '-') {
            return;
        }
        $('#synastryAspectListModal').modal('show');
    ...
    SynastryDetails.GetSynastryAspectsForArabicChart = GetSynastryAspectsForArabicChart;
    function GetSynastryAspectsForDraconicChart(draconicName, draconicCoordinates, chartToCompare) {
        if ($('#secondEnteredChartSelection').val() === '-') {
            return;
        }
        $('#synastryAspectListModal').modal('show');
    ...
    SynastryDetails.GetSynastryAspectsForDraconicChart = GetSynastryAspectsForDraconicChart;
    function GetSynastryAspectsForMidpointChart(midpointName, midpointCoordinates, chartToCompare) {
        if ($('#secondEnteredChartSelection').val() === '-') {
            return;
        }
        $('#synastryAspectListModal').modal('show');
    ...
    SynastryDetails.GetSynastryAspectsForMidpointChart = GetSynastryAspectsForMidpointChart;
    ...
    SynastryDetails.SetUpListItemElementForAspect = SetUpListItemElementForAspect;
...
})(SynastryDetails || (SynastryDetails = {}));
//# sourceMappingURL=synastry-details.js.map